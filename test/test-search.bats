...
@test "Should show full directory when searching when passed -p" {
  touch $NOTES_DIRECTORY/note.md
...
@test "Should suppress directory of a piped search when passed -s" {
  touch $NOTES_DIRECTORY/note.md
